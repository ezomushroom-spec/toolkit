...
- `docs/empirical-prompt-tuning-scored-eval-proposal_20260422.md`: Qiita 記事のような scored eval を補助層として入れる案
...
- `docs/empirical-prompt-tuning-publish-handoff_20260422.md`: branch publish と PR 作成までの記録
- `docs/empirical-prompt-tuning-pr-draft_20260422.md`: 実際に使った PR タイトルと本文の記録
- `docs/public-release-scope_20260422.md`: 公開対象と private project 除外方針
...
- scored eval は補助案として切り出し、まだ本体ルールへは昇格させていない
- `AGENTS.md` section trial は現時点で一区切り
- publish 済みの branch と PR 記録は作成済み
- 初回公開の `projects/` は `workspace-operations` の whitelist 方針
