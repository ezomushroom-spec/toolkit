...
- 現行本体: `E:\codex\workspace\projects\post-manager-remake\app`
- 計画管理フォルダ: `E:\codex\workspace\projects\post-manager-remake`

## 最初に固定すべきこと

- 実装対象の正本パスを最初に確定する
  - この handoff は `E:\codex\workspace\projects\post-manager-remake\app` を現行本体として扱う
  - ただし `projects/post-manager-remake/AGENTS.md` と `docs/implementation-plan.md` には workspace 外の旧バックアップ参照が残っている
...
- `E:\codex\workspace\projects\post-manager-remake\app\docs\リメイク前提整理_20260327.md`
- `E:\codex\workspace\projects\post-manager-remake\app\docs\リメイク実装前設計_20260327.md`
- `E:\codex\workspace\projects\post-manager-remake\app\docs\リメイク改訂実装計画_20260327.md`

### 案件側 docs

- `E:\codex\workspace\projects\post-manager-remake\docs\implementation-plan.md`
- `E:\codex\workspace\projects\post-manager-remake\docs\pre-implementation-decision-memo_20260327.md`
