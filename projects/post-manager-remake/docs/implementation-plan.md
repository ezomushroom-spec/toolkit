...
- アプリ本体: `E:\codex\workspace\projects\post-manager-remake\app`
- 参照用バックアップ: workspace 外の旧バックアップ
...
- Phase 1 の最小実装: 完了
- Phase 2 の最小実装: 完了
- コード実態では Phase 3 の主要骨格は実装済み
- 次の作業: `docs/phase3-current-state_20260402.md` を基準に、Phase 3 の残り確認と最小補修を行う
- 実装前判断は `docs/pre-implementation-decision-memo_20260327.md` で固定済み
- 実装開始可能。次の主対象は runtime / process 表示の不足確認と、その後の Phase 4 着手判断
